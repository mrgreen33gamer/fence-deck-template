...
export default function NearbyAreasHero({
  ...
  const displayHeadline = headline ?? `Fence & Deck Service in ${cityName}, TX`;
  const displayDesc     = description ??
    `TimberLine Fence & Deck provides fence and deck installs for ${cityName} and surrounding communities. Licensed crews, flat-rate quotes, 3-year workmanship warranty on every job.`;
    ...
    <section className={styles.section}>
      ...
      <div className={styles.container}>
        ...
        >
          ...
          <a href="tel:+12547536400" className={styles.phoneBtn}>
            <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round">
