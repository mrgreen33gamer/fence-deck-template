...
const SERVICE_CTAS = [
  {
    key: 'wood-fencing',
    icon: faHouseChimney,
    eyebrow: 'Wood Fencing',
    headline: 'Need a cedar privacy fence that lasts?',
    body: 'Straight lines, concrete-set posts, and HOA-friendly specs. Free on-site estimate before we dig.',
  ...
  },
  {
    ...
    headline: 'Ready for a deck built to Texas weather?',
    body: 'Wood or composite decks with solid structure, code-compliant rails, and a 3-year workmanship warranty.',
    cta: 'Start a Deck Project',
  ...
  },
  {
    ...
    eyebrow: 'Vinyl & Composite Fencing',
    headline: 'Want privacy without the reseal cycle?',
    body: 'Low-maintenance vinyl and composite systems that stay straight through Central Texas heat.',
    cta: 'Explore Vinyl Options',
    href: '/services/vinyl-composite-fencing',
    accent: 'green' as const,
  },
  {
    key: 'commercial',
    ...
    headline: 'Securing a commercial property?',
    body: 'Chain-link, privacy, and gated access for lots and HOAs — permits coordinated, schedule held.',
    cta: 'Talk to Our Team',
    href: '/services/commercial-fencing',
    accent: 'obsidian' as const,
  },
];
