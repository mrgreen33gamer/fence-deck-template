...
const LocalCitationBlock: React.FC<LocalCitationBlockProps> = ({
  businessName  = 'TimberLine Fence & Deck',
  address       = '3501 S Valley Mills Dr, Waco, TX 76711',
  phone         = '(254) 753-6400',
  email         = 'hello@timberlinefencedeck.com',
  googleMapsUrl = 'https://maps.google.com/?q=TimberLine+Fence+Deck+Waco+TX',
  hours         = DEFAULT_HOURS,
  cityName      = 'Waco',
}) => {
  return (
      ...
      <div className={styles.container}>
        ...
        <div className={styles.header}>
          ...
          <p className={styles.subtitle}>
            Based in {cityName}, TX — serving all of Central Texas with licensed fence and deck crews.
          </p>
        </div>
