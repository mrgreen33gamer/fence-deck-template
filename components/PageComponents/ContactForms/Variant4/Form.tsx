...
import {
  ...
  faTree, faBorderAll, faHammer, faTools, faDoorOpen, faBuilding, faQuestion,
...
const SERVICES = [
  { icon: faTree,      label: 'Wood Fencing',        sub: 'Privacy, picket, ranch-style wood' },
  { icon: faBorderAll, label: 'Vinyl & Composite',   sub: 'Low-maintenance fencing systems' },
  { icon: faHammer,    label: 'Deck Building',       sub: 'New wood or composite decks' },
  { icon: faTools,     label: 'Deck Repair',         sub: 'Boards, rails, resurfacing' },
  { icon: faDoorOpen,  label: 'Gate Automation',     sub: 'Driveway & entry gate openers' },
  { icon: faBuilding,  label: 'Commercial Fencing',  sub: 'Lots, HOAs, commercial sites' },
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successState}
                  ...
                  <p className={styles.successText}>
                    A TimberLine project lead will reach out shortly.
                  </p>
                ...
                <motion.div key="step2" custom={dir} variants={slideVariants}
                  ...
                  <form className={styles.form} onSubmit={handleSubmit} noValidate>
                    ...
                    <button type="submit" disabled={isSubmitting} className={styles.nextBtn}>
                      {isSubmitting
                        ? <PulseLoader size={8} color="#0c1a12" />
