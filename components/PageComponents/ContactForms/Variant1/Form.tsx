...
const SERVICES = [
  { icon: faTree,      label: 'Wood Fencing' },
  { icon: faBorderAll, label: 'Vinyl & Composite' },
  { icon: faHammer,    label: 'Deck Building' },
  { icon: faTools,     label: 'Deck Repair' },
  { icon: faDoorOpen,  label: 'Gate Automation' },
  { icon: faBuilding,  label: 'Commercial Fencing' },
];
...
const TRUST_CHIPS = [
  ...
  { icon: faStar,         text: '4.9★ · 510+ reviews' },
];
            ...
            {submitted ? (
              <motion.div key="success" className={styles.successState}
                ...
                <p className={styles.successText}>
                  A TimberLine project lead will reach out shortly. Keep an eye on your inbox and phone.
                </p>
                ...
                <form className={styles.form} onSubmit={handleSubmit} noValidate>
                  ...
                  <div className={styles.submitRow}>
                    ...
                    <div className={styles.altContact}>
                      ...
                      <span>Need help now?{' '}
                        <a href="tel:+12547536400"
                          onClick={() => trackEvent({ eventType: 'phone_click', elementLabel: 'Call (254) 753-6400', section: 'ContactForm-V1' })}>
                          Call (254) 753-6400
                        </a>
                      </span>
                    </div>
