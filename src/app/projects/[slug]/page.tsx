...
export function generateMetadata({ params }: { params: { slug: string } }): Metadata {
  ...
  return {
    title: `${project.title} | TimberLine Fence & Deck Case Study`,
    description: project.shortDesc,
    alternates: { canonical: url },
    openGraph: {
      title: `${project.title} | TimberLine Fence & Deck`,
      description: project.shortDesc,
      url, siteName: 'TimberLine Fence & Deck', locale: 'en_US', type: 'article',
