    ...
    <main className={styles.page}>
      ...
      <section className={styles.pageHeader}>
        ...
        >
          ...
          <h1 className={styles.pageTitle}>TimberLine Fence & Deck - Blog Center</h1>
          <p className={styles.pageSubtitle}>
            Real talk and useful tips for Central Texas property owners — fencing materials, deck care, repairs, and HOA-friendly builds.
          </p>
        </motion.div>
      </section>
        ...
        <div className={styles.container}>
          ...
          >
            <p className={styles.blogCTAHeading}>
              Need reliable fence and deck in Central Texas?
            </p>
            <p className={styles.blogCTABody}>
              We've been keeping Waco-area homes and businesses looking their best with expert fence and deck, fence and deck, and gate automation service since 2012. Free estimate, no obligations.
            </p>
