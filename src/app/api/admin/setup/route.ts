...
const SITE_URL    = process.env.NEXT_PUBLIC_SITE_URL ?? 'https://www.timberlinefencedeck.com';
const BRAND_NAME  = process.env.NEXT_PUBLIC_BRAND_NAME ?? 'TimberLine Fence & Deck';
    ...
    <tr>
      <td align="center" style="padding:40px 16px;">
        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0"
          ...
          <!-- Accent bar -->
          <tr>
            <td style="height:4px;background:linear-gradient(90deg,#16def9 0%,#15803d 100%);font-size:0;line-height:0;">&nbsp;</td>
          </tr>
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td style="border-radius:10px;background:#15803d;">
                    <a href="${dashboardUrl}"
                       style="display:inline-block;padding:14px 28px;font-size:15px;font-weight:600;color:#0c1a12;text-decoration:none;border-radius:10px;letter-spacing:0.01em;">
                      Open Your Dashboard →
                    </a>
                  </td>
                </tr>
