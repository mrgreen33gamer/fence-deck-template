...
// TimberLine Fence & Deck — Contact Page (unique build, not just a form import)
...
// ── Service options ────────────────────────────────────────────────────────────
const SERVICES = [
  'Wood Fencing', 'Vinyl & Composite Fencing', 'Deck Building',
  'Deck Repair & Resurfacing', 'Gate Automation', 'Commercial Fencing',
  'Other / Not Sure',
];
...
const faq = [
  {
    ...
    answer: "Call us directly at (254) 753-6400. We answer during business hours and evenings when crews are in the field. For storm-damaged fences or unsafe sections, call — don't wait on a form response.",
  },
  {
  ...
  },
  {
    ...
    answer: 'No — the initial measure and written quote are free. You\'ll know the flat-rate price before any work begins.',
  },
  {
    question: 'Do you work on commercial and HOA properties?',
    answer: 'Yes — commercial lots, builder partnerships, and HOA common-area fencing are core work for TimberLine. Call to discuss your property and schedule.',
  },
  {
  ...
  {
    question: 'How do I know if I need a repair or a full fence replacement?',
    answer: "We'll tell you honestly after the on-site look. If posts and structure are sound, sectional repair or resurfacing may be enough — if not, we'll show rebuild options with clear pricing.",
  },
];
// ── Main component ────────────────────────────────────────────────────────────
  ...
  return (
    <main className={styles.page}>
        ...
        <div className={styles.mainInner}>
          ...
          <div className={styles.leftCol}>
            ...
            <div className={styles.infoCards}>
              {[
                ...
                },
                {
                  ...
                  label:     'Email',
                  value:     'hello@timberlinefencedeck.com',
                  href:      'mailto:hello@timberlinefencedeck.com',
                ...
                },
                {
                  ...
                  label:     'Address',
                  value:     '3501 S Valley Mills Dr, Waco TX 76711',
                  href:      'https://maps.google.com/?q=3311+Franklin+Ave+Waco+TX+76711',
            ...
            <div className={styles.trustBlock}>
              <p className={styles.trustHeading}>Why property owners choose TimberLine Fence & Deck</p>
              {[
              ...
              {submitted ? (
                <motion.div key="success" className={styles.successCard}
                  ...
                  <p className={styles.successText}>
                    A TimberLine Fence & Deck team member will reach out shortly — usually within one business day. For urgent needs, call us at{' '}
                    <a href="tel:+12547536400">(254) 753-6400</a>.
                  </p>
      ...
      <CTABanner
        ...
        subline="Call (254) 753-6400 — we answer 7 days a week, evenings included. Serving all of Central Texas."
        primaryText="Call (254) 753-6400"
        primaryLink="tel:+12547536400"
        secondaryText="Send a Text"
        secondaryLink="sms:+12547536400"
      />
